...
data class Euler(
    ...
    @JvmOverloads
    fun set(x: Double, y: Double, z: Double, order: EulerOrder? = null): Euler {
        this._x = x
        this._y = y
        this._z = z
